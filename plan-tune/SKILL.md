...
7. **"Update my profile" / "I'm more scope-hungry than that" / "I've changed
...
scope-hungry than 0.5 suggests", "I've gotten more careful about architecture",
...
1. Parse the user's intent. Translate to `(dimension, new_value)`.
   - "more scope-hungry" → `scope_appetite` → pick a value 0.15 higher than
